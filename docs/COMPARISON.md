...
- **Context profiles x tolerance matrix:** Six registers (linkedin, blog, technical-blog, investor-email, docs, casual) crossed against ~25 rules, each cell strict / relaxed / skip / extra strict. A fragment is a tell in an essay and the correct form in a README.
