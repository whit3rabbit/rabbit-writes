#!/usr/bin/env python3
"""
Run the rabbit-rewrites tests without pytest.

    python3 tests/run.py                 # everything
    python3 tests/run.py -k battery      # only tests whose name matches
    python3 tests/run.py test_bench.py   # only this file
...
runners in the other skill test directories: five skills with five test
directories should not have five different ways to run a test.
"""
