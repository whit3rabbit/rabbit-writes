#!/usr/bin/env python3
"""
Run the README checker tests without pytest.

    python3 tests/run.py                 # everything
    python3 tests/run.py -k corpus       # only tests whose name matches
    python3 tests/run.py test_links.py   # only this file
