#!/usr/bin/env python3
"""
Run the CLAUDE.md checker tests without pytest.

    python3 tests/run.py                     # everything
    python3 tests/run.py -k duplicate        # only tests whose name matches
    python3 tests/run.py test_structure.py   # only this file
...
Identical to the runner in skills/rabbit-writes/tests, deliberately: two skills
with two test directories should not have two different ways to run a test.
"""
