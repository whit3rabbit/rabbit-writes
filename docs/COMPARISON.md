...
- **Context profiles x tolerance matrix:** Seven registers, a formality spine (chat, informal, blog, formal) plus three genre columns (technical-blog, docs, linkedin), crossed against ~25 rules, each cell strict / relaxed / skip / extra strict. A fragment is a tell in an essay and the correct form in a README.
