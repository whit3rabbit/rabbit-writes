...
Five or more flagged vocabulary hits across multiple categories, three or more distinct pattern categories triggered, and uniform sentence and paragraph length together mean the structure itself is generated. Patching phrases will not fix it. State the core point in one sentence and rebuild.
